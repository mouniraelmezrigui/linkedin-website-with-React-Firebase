...
const Footer = () => {
  return (
    ...
    <ul className="flex flex-wrap py-4">
        <li className="mr-4 cursor-pointer transition-all hover:text-blue-400 text-slate-500">
              <span>
                About Us
              </span>
        </li>
        ...
        <li className="mr-4 cursor-pointer transition-all hover:text-blue-400 text-slate-500">
            <div>
  <div id="ember165" className="artdeco-dropdown artdeco-dropdown--placement-top artdeco-dropdown--justification-right ember-view global-footer-dropdown">

      <span className="global-footer__link t-12 t-normal">
  ...
  <div tabIndex="-1" aria-hidden="true" id="ember172" className="artdeco-dropdown artdeco-dropdown--is-dropdown-element artdeco-dropdown--justification-right artdeco-dropdown--placement-top ember-view global-footer-dropdown__options"></div>
</div>
        </li>
        <li className="mr-4 cursor-pointer transition-all hover:text-blue-400 text-slate-500">
            <div>
  <div>
  <div id="ember173" className="ember-view"></div>

  <button id="compactfooter-get_app_footer" className="global-footer__link t-12 t-normal" type="button">
  LinkedIn.
</button>
</div>
</div>
        ...
        <li className="mr-4 cursor-pointer transition-all hover:text-blue-400 text-slate-500">
            <button id="compactfooter-more" className="global-footer__link t-12 t-normal" aria-expanded="false" aria-label="المزيد من الخيارات" type="button">
              more
            </button>
        </li>
    </ul>
